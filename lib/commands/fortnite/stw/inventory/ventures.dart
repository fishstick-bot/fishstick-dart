  ...
  Id(
    ...
    (IContext ctx) async {
      ...
      await Future.wait([
        ...
        dbUser.fnClient.campaign.venturesBackpack.init(),
      ]);
      var inventory = dbUser.fnClient.campaign.venturesBackpack;
      ...
      final EmbedBuilder embed = EmbedBuilder()
        ...
        ..title =
            "${dbUser.fnClient.displayName} | Save the World Inventory - Ventures"
